...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_jadwal");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            ...
            <th class="th_border cell">Id jabatan </th>
            <th class="th_border cell">Id Matapelajaran </th>
            <th class="th_border cell">Id manager </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_jadwal where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_jadwal where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_jadwal";
            }
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <td align="center"><?php echo $data['id_matapelajaran']; ?></td>
                    <td align="center"><?php echo $data['id_manager']; ?></td>
