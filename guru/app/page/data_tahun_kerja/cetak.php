...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_tahun_kerja");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            ...
            <th class="th_border cell">Id tahun kerja </th>
            <th class="th_border cell">tahun kerja </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_tahun_kerja where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_tahun_kerja where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_tahun_kerja";
            }
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <td align="center"><?php echo $data['id_tahun_kerja']; ?></td>
