        ...
        <table <?php tabel(100, '%', 1, 'left'); ?> >
            ...
            <tbody>
                ...
                if (isset($_GET['Berdasarkan']) && !empty($_GET['Berdasarkan']) && isset($_GET['isi']) && !empty($_GET['isi'])) {
                    ...
                    $querytabel = "SELECT * FROM data_absensi where $berdasarkan like '%$isi%' and id_guru='$id_guru' LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_absensi where $berdasarkan like '%$isi%' and id_guru='$id_guru'";
                } else {
                    $querytabel = "SELECT * FROM data_absensi where id_guru='$id_guru' LIMIT $startRow ,$dataPerPage";
                    $querypagination = "SELECT COUNT(*) AS total FROM data_absensi where id_guru='$id_guru'";
                }
