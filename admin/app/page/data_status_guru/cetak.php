...
if (isset($_GET['input'])) {
    ...
    proses_action_cetak("data_status_guru");
    ?>
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new.css">
    <link rel="stylesheet" type="text/css" href="../../../data/cssjs/cetak/style_new2.css">
    ...
    <table width="100%"  class="tblcms2">
        <tr>
            ...
            <th class="th_border cell">Id status_guru </th>
            <th class="th_border cell">status_guru </th>
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_status_guru where $Berdasarkan like '%$isi%'";
                ...
                $querytabel = "SELECT * FROM data_status_guru where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2')";
            } else {
                //SEMUA
                $querytabel = "SELECT * FROM data_status_guru";
            }
            ...
            while ($data = mysql_fetch_array($proses)) {
                ...
                <tr class="event2">
                    ...
                    <td align="center"><?php echo $data['id_status_guru']; ?></td>
